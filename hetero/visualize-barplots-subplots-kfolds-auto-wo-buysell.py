...
auc_rocs_train = {key: value for key, value in auc_rocs_train.items() if buy_sell_edge not in key}
accs_train = {key: value for key, value in accs_train.items() if buy_sell_edge not in key}

auc_rocs_test = {key: value for key, value in auc_rocs_test.items() if buy_sell_edge not in key}
accs_test = {key: value for key, value in accs_test.items() if buy_sell_edge not in key}
